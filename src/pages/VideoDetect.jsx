...
const response = await fetch("http://10.25.18.85:8001/detect-video",{
method:"POST",
body:formData
})
...
<video
controls
className="mb-6 rounded-lg max-h-48 mx-auto"
...
result.label === "real" ? "text-green-600" : "text-red-600"
}`}>
